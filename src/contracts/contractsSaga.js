...
function createTxChannel({ txObject, stackId, sendArgs = {}, contractName, stackTempKey }) {
  var persistTxHash
...
function* callSendContractTx({ contract, fnName, fnIndex, args, stackId, stackTempKey }) {
