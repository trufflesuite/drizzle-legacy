...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_69__, __WEBPACK_EXTERNAL_MODULE_70__, __WEBPACK_EXTERNAL_MODULE_120__, __WEBPACK_EXTERNAL_MODULE_122__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scheduler__ = __webpack_require__(128);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
exports.generateStore = exports.Drizzle = undefined;

var _Drizzle = __webpack_require__(75);

var _Drizzle2 = _interopRequireDefault(_Drizzle);

var _generateStore = __webpack_require__(121);
...
var _DrizzleContract = __webpack_require__(102);

var _DrizzleContract2 = _interopRequireDefault(_DrizzleContract);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Web3 = __webpack_require__(120);
  ...
  (0, _createClass3.default)(Drizzle, [{
    ...
    value: function getAccounts() {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        return new _promise2.default(function (resolve, reject) {
          _this2.store.dispatch({ type: 'GET_BALANCES', web3: web3, accounts: accounts, resolve: resolve, reject: reject });
        });
      }).then(function () {
        _this2.getContracts();
    ...
    value: function observeBlocks() {
      ...
      this.web3.eth.subscribe('newBlockHeaders', function (error, result) {
        ...
        if (blockHeader.number !== null) {
          ...
          _this4.web3.eth.getBlock(blockNumber, true).then(function (block) {
            ...
            if (txs.length > 0) {
              ...
              for (var i = 0; i < txs.length; i++) {
                if (contractAddresses.indexOf(txs[i].from) !== -1 || contractAddresses.indexOf(txs[i].to) !== -1) {
                  ...
                  _this4.store.dispatch({ type: 'CONTRACT_SYNCING', contract: _this4.contracts[contractName] });
                }
                ...
                if (accountAddresses.indexOf(txs[i].from) !== -1 || accountAddresses.indexOf(txs[i].to) !== -1) {
                  ...
                  _this4.store.dispatch({ type: 'GET_ACCOUNT_BALANCE', account: account, web3: web3 });
                }
              }
            }
            return true;
...
var _rootSaga = __webpack_require__(123);
...
function generateStore(options) {
  ...
  var store = (0, _redux.createStore)(_reducer2.default, preloadedState, composeEnhancers((0, _redux.applyMiddleware)(sagaMiddleware, _reduxThunk2.default)));
...
var _contractsSaga = __webpack_require__(131);

var _contractsSaga2 = _interopRequireDefault(_contractsSaga);

var _accountsSaga = __webpack_require__(136);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__takeEvery__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__takeLatest__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__throttle__ = __webpack_require__(130);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          console.error('No accounts found!');
          _context2.next = 4;
          return (0, _effects.call)(action.reject, { source: 'accounts', message: 'Failed to get balances.' });
...
var _extends13 = __webpack_require__(13);
